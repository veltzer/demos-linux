...
/*
 * This example shows the page faults that are generated by access to an mmaped
 **file.
 *
...
int main(int argc, char** argv, char** envp) {
	...
	void *res=CHECK_NOT_VOIDP(mmap(
			...
			// MAP_PRIVATE | MAP_POPULATE, /* flags: PRIVATE or
			// SHARED ** MUST** be specified */
			MAP_PRIVATE,	/* flags: PRIVATE or SHARED ** MUST** be
					   specified */
	...
	// I must collect the sum and print it otherwise the compiler will
	// optimize
