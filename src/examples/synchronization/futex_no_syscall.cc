 ...
 *
 * Notes:
 * - there is no syscall involved with this futex AT ALL! This is because this
 **futex is private
 *	and therefore not robust. Futexes can be robust in which case you need
 **to tell that at creation
 ...
 *
 * Problem:
 * - even if I create a process shared mutex the pthread library calls no
 **syscall at mutex_init time!!!
