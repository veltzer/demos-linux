...
/*
        ...
        - for the main thread (the one going from the main function) the thread
           id
        is the same as the process id.
        - for other threads the process id is the same but the thread id is
           different.
        ...
        here that I defined myself in <us_helper.hh>. Check it out. You can
           either
