...
- create a library of your own with the same interface and load it dynamically before calling the executable using the LD_PRELOAD environment variable. In this case you do not need to interfere with the linking of procedure of the application but rather with the running of the application (or rather the environment of the application). In this case you cannot call the original libraries version.
- In case you want to call the original libraries version then create a library of your own with the same interface, load the original library using dlopen and call it whenever you want.
